...
class MarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mark" do
    assert_difference('Mark.count') do
      post marks_url, params: { mark: { content: @mark.content, course_id: @mark.course_id, title: @mark.title } }
    end
  ...
  test "should update mark" do
    patch mark_url(@mark), params: { mark: { content: @mark.content, course_id: @mark.course_id, title: @mark.title } }
